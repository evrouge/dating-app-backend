...
"""
Django settings for dating_app_api project.
...
SECRET_KEY = 'django-insecure-h&j(v!^+e#hozhm7*vkv(#f-5tgf5+&z8ohur&263b+7^t%qo7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'serene-mountain-09515.herokuapp.com']
...
ROOT_URLCONF = 'dating_app_api.urls'
...
WSGI_APPLICATION = 'dating_app_api.wsgi.application'
